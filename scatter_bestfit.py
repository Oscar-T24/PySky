...
# Calculate the weighted mean of max_slope_y using trusts as weights
weighted_mean_y = np.average(max_slope_y, weights=trusts)
...
ax.axhline(y=weighted_mean_y, color='r')
